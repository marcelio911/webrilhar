...
(function ($) {
    $.fn.html5form = function (options) {
        $(this).each(function () {
            ...
            $.each($(':input:visible:not(:button, :radio, :checkbox, select)', form), function (i) {
                fillInput($(this));
            ...
            $.each($('input:image, input:button', this), function () {
                $(this).bind('click', function (ev) {
                    var emptyInput = null;
                    var emailError = null;
                    var input = $(':input:visible:not(:button, :radio, :checkbox, select)', form);
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $.each(form[0], function () {
                                        fillInput($(this).not(':hidden, :button, :radio, :checkbox, select'));
